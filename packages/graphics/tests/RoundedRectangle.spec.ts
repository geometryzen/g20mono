...
describe("RoundedRectangle", function () {
        ...
        return new Promise<void>((resolve, reject) => {
            setTimeout(() => {
                try {
                    ...
                    expect(viewee.getAttribute('d')).toBe("M -0.707107 -0.507107 L -0.707107 0.507106 L -0.507107 0.707106 L 0.507106 0.707106 L 0.707106 0.507106 L 0.707106 -0.507107 L 0.507106 -0.707107 L -0.507107 -0.707107 L -0.707107 -0.507107 L -0.707107 -0.507107 Z");
                    board.dispose();
                    resolve();
                }
                catch (e) {
    ...
    it("options", function () {
        const element = new MockElement('div');
        const board = initMockBoard(element);
        const shape = new RoundedRectangle(board, { width: 1, height: 1, radius: 0.2 });
        board.add(shape);
        expect(shape.id).toBe(null);
