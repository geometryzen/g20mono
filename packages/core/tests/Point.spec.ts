        ...
        return new Promise<void>((resolve, reject) => {
            setTimeout(() => {
                try {
                    ...
                    expect(textview.getAttributeNames()).toStrictEqual(["fill", "font-family", "font-size", "id", "stroke", "stroke-width", "transform"]);
                    ...
                    expect(textview.getAttribute("stroke")).toBe("gray");
                    expect(textview.getAttribute("stroke-width")).toBe("0.009375");
