...
export { Parent, ShapeBase, ShapeOptions } from "./lib/ShapeBase";
export { ArcSegment, ArcSegmentOptions } from "./lib/shapes/ArcSegment";
export { Arrow, ArrowOptions } from "./lib/shapes/Arrow";
...
export { Point, PointOptions } from "./lib/shapes/Point";
