...
export { Board, BoardAttributes, freeBoard, initBoard, PointAttributes } from './lib/Board';
...
export { CircleAttributes, CircleProperties, CircularPath } from './lib/shapes/Circle';
export { EllipseAttributes, EllipticalPath } from './lib/shapes/EllipticalPath';
export { LinearPath, LineAttributes, LineProperties } from './lib/shapes/Line';
