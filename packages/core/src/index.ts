...
export { Shape, SVGAttributes } from "./lib/Shape";
...
export { Line, LineOptions } from "./lib/shapes/Line";
...
export { Text, TextDecoration, TextOptions } from "./lib/Text";
export { Commands } from "./lib/utils/Commands";
export { ViewDOM } from "./lib/ViewDOM";
